...
ActiveRecord::Schema.define(version: 2022_05_03_081135) do
  ...
  create_table "glueby_timestamps", force: :cascade do |t|
    ...
    t.string "prefix"
    t.string "wallet_id"
    t.integer "timestamp_type", default: 0, null: false
    t.string "p2c_address"
    t.string "payment_base"
    t.bigint "prev_id"
    t.boolean "latest", default: true, null: false
    t.index ["prev_id"], name: "index_glueby_timestamps_on_prev_id", unique: true
  end
